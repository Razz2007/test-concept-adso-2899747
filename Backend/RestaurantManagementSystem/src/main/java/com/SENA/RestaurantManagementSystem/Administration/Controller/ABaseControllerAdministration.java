...
import com.SENA.RestaurantManagementSystem.Administration.DTO.ApiResponseDto;
...
public abstract class ABaseControllerAdministration <T extends ABaseEntityAudit, DReq, DRes, S extends IBaseServiceAdministration<T, DReq, DRes>> {
    protected S service;
    protected String entityName;

    protected ABaseControllerAdministration(S service, String entityName) {
