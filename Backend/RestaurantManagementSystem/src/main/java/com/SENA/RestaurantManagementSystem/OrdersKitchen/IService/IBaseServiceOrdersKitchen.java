package com.SENA.RestaurantManagementSystem.OrdersKitchen.IService;
...
public interface IBaseServiceOrdersKitchen<T extends ABaseEntityOrdersKitchenBase, DReq, DRes> {
    /**
