...
import com.SENA.RestaurantManagementSystem.OrdersKitchen.Entity.ABaseEntityOrdersKitchen;
...
abstract public class ABaseServiceOrdersKitchen<T extends ABaseEntityOrdersKitchenBase, DReq, DRes> implements IBaseServiceOrdersKitchen<T, DReq, DRes> {
     ...
     */
    protected abstract IBaseRepositoryOrdersKitchen<T, String> getRepository();
